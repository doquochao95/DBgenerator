...
import { MSSqlConnnection } from "../core/mssqlConnection";
import { QueryUnit } from "../core/queryUnit";

export class SqlService {
    public async execute(connection: ConnectionOption): Promise<TableModel[]> {
